# PowerSynth Mostcool Release Series Core Repository
## Repository Overview
This is the gui repository for PowerSynth Mostcool. Refer to the [PowerSynth2-core](https://github.com/e3da/PowerSynth2-core) and other related repos for the CLI and other parts. 
This repository contains the main source code for the Qt-based PowerSynth Mostcool GUI and design files. 
